package com.javacourses.homework.functional_programming.double_arrays;

import com.javacourses.lesson_practice.functional_progr.Util;

public class DoubleArrayTask extends Util {
    public static void main(String[] args) {
        int[][] array = new int[5][5];
        printDouble(array);
        summFirstLastLine(array);
        printDoubleArrayWithStars();
        getMaxDoubleArrayDiagonalValue(array);
    }
